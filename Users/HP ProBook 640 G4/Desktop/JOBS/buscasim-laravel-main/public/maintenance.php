...
<html>
    <title>Buscasim | Manutenção</title>
<style>
    body {
        margin: 0;
        padding: 0;
    ...
    <div class="maintenance">
        <div class="maintenance_contain">
            ...
            <div class="pp-infobox-title-wrapper">
                <h3 class="pp-infobox-title">Estamos realizando manutenção no site!</h3>
            </div>
            <div class="pp-infobox-description">
                <p>Estamos atualizando nossos servidores para melhorar a sua experiência. Por favor, volte mais tarde.</p>
            </div>
            <!-- redes sociais -->
            <!-- <span class="title-text pp-primary-title">Siga-nos nas redes sociais</span> -->
            <!-- <div class="pp-social-icons pp-social-icons-center pp-responsive-center">
                ...
                <span class="pp-social-icon">
                    <a href="#" target="_blank" title="Google Plus" aria-label="Google Plus" role="button">
