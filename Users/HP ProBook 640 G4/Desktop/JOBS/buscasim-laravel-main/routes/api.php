...
Route::middleware('auth:api')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::prefix('permissions')->group(function() {
            Route::get('/get-permissions', [PermissionsController::class, 'getPermissionsByLoggedUser']);
            Route::post('/create-permissions', [PermissionsController::class, 'store']);
            Route::post('/update-permissions', [PermissionsController::class, 'update']);
            Route::get('/show-permissions/{id}', [PermissionsController::class, 'show']);
        });
    });
});
