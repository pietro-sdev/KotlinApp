...
import styles from './passwordRedefine.module.css'
...
function PasswordRedefine() {
    ...
    const sendNewPasssowrd = () => {
        ...
        api.post("/user/newPassword", {
            hash,
            _id: id,
            password: passwordOne
        }).then(() => {
            setPasswordError("Senha redefinida! Entre na sua conta pelo login.")
                ...
                <div className={styles.contentCard}>
                    <div className={styles.textFieldSection}>
                        ...
                        <TextField
                            fullWidth
                            variant="filled"
                            label="Re-digite sua nova senha"
                            id="fullWidth"
                            className={styles.textField}
                            type="password"
                            value={passwordTwo} 
                        ...
                        />
                        <button onClick={sendNewPasssowrd} className={styles.btn}>Redefinir senha</button>
                        <p>{passwordError}</p>
                    </div>
